export const Specification = () => (
  <>
    <h3 class="section__subheader">Requirements for the Currency-Converter website</h3>
    <p>
    ...
    <h3 class="section__subheader">Project visualisation</h3>
    <img class="section__image" src="images/currencyConverter/pageScreen1.jpg" alt="" />
    <img class="section__image" src="images/currencyConverter/pageScreen2.jpg" alt="" />
  </>
);
